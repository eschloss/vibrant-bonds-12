        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="backdrop-blur-sm bg-white/5 dark:bg-black/20 border border-primary/20 rounded-2xl p-4 sm:p-6 md:p-8 text-center">
              <div>
                <h3 className="text-base font-medium text-white/70 uppercase tracking-wider mb-6 text-center">
                  {translate("mission_deadline.get_matched", "Get Matched")}
                </h3>
                <div className="flex justify-center mb-4">
                  <div>
                    <h4 className="text-xl font-semibold text-white tracking-tight md:text-2xl">
                      {translate("mission_deadline.next_friend_match", "Next friend match happens in...")}
                    </h4>
                  </div>
                </div>
            ...
            <div className="backdrop-blur-sm bg-white/5 dark:bg-black/20 border border-primary/20 rounded-2xl p-4 sm:p-6 md:p-8 text-center">
              <div>
                <h3 className="text-base font-medium text-white/70 uppercase tracking-wider mb-6 text-center">
                  {translate("mission_deadline.meet_in_person", "Meet in Person")}
                </h3>
                <div className="flex justify-center mb-4">
                  <div>
                    <h4 className="text-xl font-semibold text-white tracking-tight md:text-2xl">
                      {translate("mission_deadline.countdown_begins", "Countdown begins after joining a group.")}
                    </h4>
                  </div>
                </div>
                <div className="mt-2 flex flex-col items-center">
