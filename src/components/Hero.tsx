...
const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative flex items-center overflow-hidden section-padding bg-white dark:bg-white pt-32 md:pt-36 lg:pt-40">
      ...
      <div className="absolute top-2/3 left-1/4 w-20 h-20 pointer-events-none rounded-full bg-pulse-coral/20 animate-ambient-drift" style={{ animationDelay: '5s' }}></div>
      <div className="absolute top-1/2 right-1/3 w-8 h-8 pointer-events-none rounded-full bg-pulse-blue/20 animate-sophisticated-float" style={{ animationDelay: '12s' }}></div>
      <div className="absolute bottom-1/3 left-1/3 w-14 h-14 pointer-events-none rounded-full bg-pulse-purple/25 animate-ambient-drift" style={{ animationDelay: '3s' }}></div>
      <div className="absolute top-1/6 right-1/6 w-10 h-10 pointer-events-none rounded-full bg-pulse-coral/20 animate-sophisticated-float" style={{ animationDelay: '15s' }}></div>
      <div className="absolute bottom-1/5 left-1/5 w-18 h-18 pointer-events-none rounded-full bg-pulse-teal/15 animate-ambient-drift" style={{ animationDelay: '1s' }}></div>
