...
const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative flex items-center overflow-hidden section-padding bg-white dark:bg-white pt-32 md:pt-36 lg:pt-40">
      ...
      <div className="absolute top-2/3 left-1/4 w-20 h-20 rounded-full bg-pulse-coral/20 animate-ambient-drift" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="absolute bottom-1/5 left-1/5 w-18 h-18 rounded-full bg-pulse-teal/15 animate-ambient-drift" style={{ animationDelay: '6s' }}></div>
