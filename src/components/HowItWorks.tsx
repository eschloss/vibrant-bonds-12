...
const steps = [{
  ...
  icon: CalendarDays,
  title: "We'll Plan a Meetup<br/>—Just Show Up",
  ...
  description: "One hangout's just the beginning. We'll help you keeep the momentum going<br/>—so new connections turn into real friends.",
