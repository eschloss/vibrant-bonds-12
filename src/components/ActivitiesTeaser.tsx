      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {itemsToShow.map((it, i) => (
            ...
            >
              <img src={it.image} alt={`Meet New ${t(it.name, it.name)} Friends`} className="w-full h-full object-contain" loading="lazy" decoding="async" sizes="(max-width: 768px) 50vw, 12vw" onError={(e) => { (e.currentTarget as HTMLImageElement).src = "/placeholder.svg"; }} />
