...
const CityMatchmakingTemplate = ({ cityName }: CityMatchmakingTemplateProps) => {
  return (
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            duration: 0.7
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white">
                Make Friends in <span className="pulse-gradient-text">{cityName}</span>
              </h1>
              ...
              delay: 0.2,
              duration: 0.5
            }}>Life's too short for awkward small talk. Meet people who get you in {cityName}.</motion.p>
              <motion.div initial={{
              opacity: 0,
              y: 10
            }} animate={{
