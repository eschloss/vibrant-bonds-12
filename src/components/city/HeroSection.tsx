...
const HeroSection = ({
  ...
  return (
    <section className="relative flex items-center overflow-hidden section-padding bg-white dark:bg-white pt-32 md:pt-36 lg:pt-40">
      ...
      {/* Background image with smooth crossfade on decode */}
      {image && image !== "" ? (
        <HeroBackgroundImage
          src={`https://${image}`}
