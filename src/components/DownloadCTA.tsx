  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto">
        ...
        <div className="bg-gradient-to-br from-gray-900 via-indigo-900/90 to-gray-900 rounded-3xl p-8 md:p-12 shadow-xl border border-gray-800 relative overflow-hidden text-white max-w-4xl mx-auto">
