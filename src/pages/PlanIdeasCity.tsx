  ...
  const planIdeas = [
    {
      ...
      description: "Start with something simple - a cozy café where your group can chat and get to know each other over great coffee and pastries.",
      time: "1-2 hours",
    ...
    },
    {
      ...
      description: "Explore local restaurants, food markets, or try a cooking class together. Nothing bonds people like sharing a great meal and new flavors.",
      time: "2-3 hours",
    ...
    },
    {
      ...
      title: "Game Night",
      description: "Board games, trivia nights, or arcade venues - perfect for breaking the ice and bringing out everyone's playful, competitive side.",
      time: "2-4 hours",
      groupSize: "4-8 people",
    ...
    },
    {
      ...
      description: "Hiking trails, park picnics, or outdoor sports. Fresh air and shared challenges create lasting memories and natural bonding moments.",
      time: "3-6 hours",
    ...
    },
    {
      ...
      description: "Museums, live music venues, art galleries, or local festivals. Discover your city's culture together and spark interesting conversations.",
      time: "2-4 hours",
    ...
    },
    {
      ...
      title: "Photo Walk",
      description: "Explore interesting neighborhoods, capture memories, and see your city through fresh eyes together while creating lasting photo memories.",
      time: "2-3 hours",
      groupSize: "4-8 people",
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
                Discover amazing activity ideas perfect for friend groups. From laid-back coffee hangouts to exciting adventures, here are the kinds of plans that turn strangers into lifelong friends.
              </p>
            </div>
          </motion.div>
        </div>
