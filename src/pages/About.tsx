        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div 
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl md:text-4xl font-bold">Meet Eric</h2>
              <div className="h-1 w-20 bg-gradient-to-r from-pulse-purple to-pulse-blue rounded-full"></div>
              <p className="text-gray-300 text-lg">
                As an opera singer, Eric traveled the world, performing on stages from Milan to New York, Tokyo to Sydney. With each new city came the challenge every global nomad knows all too well: building a community from scratch.
              </p>
              <p className="text-gray-300 text-lg">
                "Every few months, I'd find myself in a new place where I knew no one," Eric recalls. "I'd have to start from zero, building relationships while juggling rehearsals and performances."
              </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/cities">
                <Button 
                  size="xl"
                  variant="gradient"
                  className="rounded-full shadow-lg shadow-purple-500/20 w-full sm:w-auto"
                >
                  Find your city
                </Button>
              </Link>
              <Link to="/matchmaking">
                <Button 
                  size="xl"
                  variant="coral"
                  className="rounded-full shadow-lg shadow-pink-500/20 w-full sm:w-auto"
                >
                  Get matched
                </Button>
              </Link>
