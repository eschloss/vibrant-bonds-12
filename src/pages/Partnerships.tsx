...
const Partnerships = () => {
  ...
  const seoProps = {
    title: {
      en: "Business Partnerships | Connect Communities | Pulse",
      es: "Asociaciones Comerciales | Conecta Comunidades | Pulse"
    },
    description: {
      en: "Partner with Pulse to bring meaningful connections to your audience. Discover partnership opportunities to strengthen community engagement.",
      es: "Asóciate con Pulse para llevar conexiones significativas a tu audiencia. Descubre oportunidades de asociación para fortalecer el compromiso comunitario."
    },
  ...
  const partnershipSteps = [{
    ...
    description: "We start with understanding your community and goals to create the perfect collaboration.",
    color: "bg-gradient-to-r from-pink-500 to-purple-600"
  }, {
    icon: Target,
    title: "Custom Integration",
    description: "We tailor our group matching technology to fit seamlessly with your brand and community.",
    color: "bg-gradient-to-r from-blue-500 to-cyan-400"
  }, {
    icon: Network,
    title: "Launch Together",
    description: "We co-launch the partnership with your community, ensuring maximum engagement from day one.",
    color: "bg-gradient-to-r from-stone-500 to-rose-500"
  }, {
    icon: TrendingUp,
    title: "Grow Together",
    description: "Track success metrics and continuously optimize to drive community growth and engagement.",
  ...
  const partnershipTypes = [{
    ...
    description: "Help your employees build meaningful connections beyond work, fostering a stronger company culture and team dynamics."
  }, {
    icon: <Award className="text-white h-6 w-6" />,
    title: "Brand Collaborations",
    description: "Partner with us to create authentic community experiences that align with your brand values and reach engaged audiences."
  }, {
    icon: <Globe className="text-white h-6 w-6" />,
    title: "Platform Integrations",
    description: "Integrate Pulse's matching technology into your existing platform to enhance user engagement and retention."
  }, {
    icon: <Megaphone className="text-white h-6 w-6" />,
    title: "Event Partnerships",
    description: "Collaborate on events and experiences that bring communities together in meaningful ways."
  }, {
    icon: <Users className="text-white h-6 w-6" />,
    title: "Community Leaders",
    description: "Work with us to amplify your community leadership and create lasting impact through authentic connections."
  }, {
    icon: <Sparkles className="text-white h-6 w-6" />,
    title: "Innovation Partners",
    description: "Join us in pioneering new ways to build human connection in the digital age."
  }];
        ...
        <div className="container mx-auto px-4 relative z-10 py-[85px]">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
              Join us in revolutionizing how people connect. Whether you're a brand, platform, or community leader, let's create meaningful partnerships that bring people together in real life.
            </p>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From corporate partnerships to brand collaborations, we work with organizations that share our vision of meaningful human connection.
            </p>
          </motion.div>
      ...
      <section className="relative py-12 bg-gray-900/50 backdrop-blur-lg">
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center max-w-3xl mx-auto mb-10">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">How Partnership Works</h2>
            <p className="text-gray-300">From initial discussion to launch and beyond</p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-lg rounded-3xl border border-gray-700 p-8 md:p-12 max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              Let's discuss how we can work together to create meaningful connections for your community.
            </p>
