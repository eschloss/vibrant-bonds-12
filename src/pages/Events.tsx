  ...
  const cities = [
    {
      ...
      description: "From pub crawls to Thames walks, London offers endless group adventures.",
      eventCount: "50+ activity ideas"
    },
    {
      name: "Los Angeles",
      slug: "los-angeles",
        ...
        <div className="container mx-auto px-4 relative z-10 py-[85px]">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-10 max-w-3xl mx-auto">
              Discover amazing group activities in cities worldwide. From casual coffee meetups to epic adventures, explore the kinds of plans that turn acquaintances into lifelong friends.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }} className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Click on any city to discover curated activity ideas perfect for friend groups. Each city has unique experiences waiting to be explored together.
            </p>
          </motion.div>
                ...
                <Link to={`/events/${city.slug}`}>
                  <Card className="bg-gray-800/50 backdrop-blur-lg border-gray-700 hover:border-purple-500/50 transition-all duration-300 h-full group hover:scale-105 overflow-hidden">
                    <div className="relative h-48 overflow-hidden">
                      <img 
                        src={city.image} 
                        alt={`${city.name} events and activities`}
