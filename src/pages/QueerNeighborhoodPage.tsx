...
const QueerNeighborhoodPage = () => {
  ...
  const seoProps = {
    title: {
      en: neighborhoodData
        ? `Meet Gay, Lesbian, & Queer Friends in ${String(neighborhoodData.name)} | Pulse App`
        : "Find LGBTQ+, Gay, Lesbian, & Queer Friends Near You | Pulse App",
      es: neighborhoodData
        ? `Conoce Amigues Gay, Lesbianas y Queer en ${String(neighborhoodData.name)} | Pulse App`
        : "Encuentra Amigues LGBTQ+, Gay, Lesbianas y Queer Cerca de Ti | Pulse App"
    },
    description: {
      en: neighborhoodData
        ? `Meet LGBTQ+ friends in ${String(neighborhoodData.name)}. Join queer friend groups, plan IRL meetups, and make real connections in ${String(neighborhoodData.name)} with Pulse.`
        : "Meet LGBTQ+ friends near you. Join queer friend groups, plan IRL meetups, and build real connections with Pulse.",
      es: neighborhoodData
        ? `Conoce amigues LGBTQ+ en ${String(neighborhoodData.name)}. Únete a grupos queer, planifica quedadas en persona y crea conexiones reales en ${String(neighborhoodData.name)} con Pulse.`
    ...
    keywords: neighborhoodData
      ? [
          `${String(neighborhoodData.name)} LGBTQ+ friends`,
          `meet queer friends in ${String(neighborhoodData.name)}`,
          `${String(neighborhoodData.name)} queer community`,
...
export default QueerNeighborhoodPage;
