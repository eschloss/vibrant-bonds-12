        ...
        <div className="container mx-auto px-4 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              ...
              <a href="https://instagram.pulsenow.app" target="_blank" rel="noopener noreferrer" className="px-4 py-2 rounded-full bg-gradient-to-r from-pulse-pink via-pulse-purple to-pulse-blue text-white hover:opacity-95 transition-opacity">
