...
export const fetchTranslations = async (lang: string) => {
  ...
  if (locale === "es") {
    const [shared, about, mission, activities, realLifeMagic, city, citylist, eventsCities, communities, contact, forms, hero, howItWorks, icebreakers, team, lonelinessEpidemic, legal, faq, download, almostThere, eventConfirmation, eventDetail, eventCheckout] = await Promise.all([
      ...
      import("./eventsCities").then(m => m.eventsCities.es),
      ...
      import("./eventDetail").then(m => m.eventDetail.es),
      import("./eventCheckout").then(m => m.eventCheckout.es),
    ]);
    return {
      ...shared,
      ...about,
  ...
  const [shared, about, mission, activities, realLifeMagic, city, citylist, eventsCities, communities, contact, forms, hero, howItWorks, icebreakers, team, lonelinessEpidemic, legal, faq, download, almostThere, eventConfirmation, eventDetail, eventCheckout] = await Promise.all([
    ...
    import("./eventsCities").then(m => m.eventsCities.en),
    ...
    import("./eventDetail").then(m => m.eventDetail.en),
    import("./eventCheckout").then(m => m.eventCheckout.en),
  ]);
  return {
    ...shared,
    ...about,
