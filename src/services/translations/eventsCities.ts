export const eventsCities = {
  en: {
    "eventsCities.partner.kicker": "For venues & hosts",
    "eventsCities.partner.title": "Run Pulse Events in your city",
  ...
  es: {
    ...
    "eventsCities.partner.title": "Organiza Pulse Events en tu ciudad",
    "eventsCities.partner.subtitle":
